        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div>
                <h1 class="text-4xl md:text-5xl font-bold mb-6">
                    ...
                    <span class="text-ph-yellow">Court Reservation System</span>
                </h1>
                <p class="text-xl text-blue-100 mb-8">
                    Basketball, Volleyball, Badminton, and more. 
                    Pay easily with GCash QR.
                </p>
                    ...
                    <div class="bg-white/10 rounded-2xl p-6 backdrop-blur-sm">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-white rounded-xl p-4 text-gray-800">
                                ...
                                <p class="text-sm text-gray-500">Full Courts</p>
                            </div>
                            <div class="bg-white rounded-xl p-4 text-gray-800">
                                <i class="fas fa-table-tennis text-green-500 text-3xl mb-2"></i>
                                <h3 class="font-semibold">Ping Pong</h3>
                                <p class="text-sm text-gray-500">Indoor Ping Pong</p>
                            </div>
                            <div class="bg-white rounded-xl p-4 text-gray-800">
                                <i class="fas fa-volleyball-ball text-yellow-500 text-3xl mb-2"></i>
                                <h3 class="font-semibold">Volleyball</h3>
                                <p class="text-sm text-gray-500">Clay & Hard Courts</p>
                            </div>
                            <div class="bg-white rounded-xl p-4 text-gray-800">
                                <i class="fas fa-table-tennis text-blue-500 text-3xl mb-2"></i>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div class="text-center">
                ...
                <p class="text-gray-500 text-sm">Scan QR code and pay with GCash</p>
            </div>
